...
Here are some examples of Hamiltonians of different systems.

\begin{myboxes}{Examples of Hamiltonians of different systems}{}
\begin{enumerate*}
...
\item A particle magnetic moment $\vec{\mu}$, in external magnetic field $\vec{B}$
